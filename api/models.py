...
class Business(models.Model):
    ...
    mapCoordinates = models.CharField(max_length=128, blank=True)
    address = models.CharField(max_length=128, blank=True)
    group = models.CharField(max_length=128)
    groupID = models.PositiveIntegerField(default=-1)
    category = models.CharField(max_length=128, blank=True)
    type = models.CharField(max_length=128, blank=True)
    workingHours = models.CharField(max_length=128, blank=True)
    ...
    thumbnailURL = models.TextField(max_length=1024, blank=True)
